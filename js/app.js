...
const mediaPlayer = function(t, config) {
  ...
  t.player = {
    ...
    init: function() {
      ...
      this.volume(store.get('_PlayerVolume') || '0.2')
...
const scrollHandle = function (event) {
  ...
  // 页面滚动背景渐进模糊效果
    ...
    //console.log(s);
	//console.log($("#imgs"));
	$('#imgs').attr('style', '-webkit-filter:blur('+s/30+'px)');
